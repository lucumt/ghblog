...
* 两个矩形边角相交以及完全包含
  ...
  ![矩形相交1](/blog_img/algorithm/calculate-total-area-of-two-rectangles/intersect1.png "两个矩形边角相交以及完全包含")

* 矩形横向相交

  ![矩形相交2](/blog_img/algorithm/calculate-total-area-of-two-rectangles/intersect2.png "矩形横向相交")

* 矩形纵向相交

  ![矩形相交3](/blog_img/algorithm/calculate-total-area-of-two-rectangles/intersect3.png "矩形纵向相交")

* 矩形被完全包含

  ![矩形相交4](/blog_img/algorithm/calculate-total-area-of-two-rectangles/intersect4.png "矩形被完全包含")
...
![矩形相交坐标计算](/blog_img/algorithm/calculate-total-area-of-two-rectangles/position_calculate.png "矩形相交时形成的新矩形的坐标来源")  
...
![矩形不相交坐标计算](/blog_img/algorithm/calculate-total-area-of-two-rectangles/no_interact_position_compare.png "矩形不相交的4种情况")  
相应的代码实现如下：
